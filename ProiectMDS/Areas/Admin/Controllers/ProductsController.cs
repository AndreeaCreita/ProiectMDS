...
namespace ProiectMDS.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        //constructor
        public ProductsController(ProiectMDSContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            int pageSize = 6;
            // Skip deoarece paginarea incepe de la 1
        ...
        public async Task<IActionResult> Create(Product product) //IactionResults catch all for returns
        {
            ViewBag.CategoryId = new SelectList(context.Categories.OrderBy(x => x.Sorting), "Id", "Name");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Product product) //IactionResults catch all for returns
        {
            ViewBag.CategoryId = new SelectList(context.Categories.OrderBy(x => x.Sorting), "Id", "Name", product.CategoryId);
            if (ModelState.IsValid)
            {
