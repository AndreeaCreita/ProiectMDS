...
namespace ProiectMDS.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ProiectMDSContext context)
        {
        ...
        // GET /products/category    //afiseaza produsele dupa categorie  -> dupa pune in Startup (set the route in Startup)
        public async Task<IActionResult> ProductsByCategory(string categorySlug, int p = 1)
        {
            ...
            return View(await products.ToListAsync());   //ii face un view pentru afisare
        }
    }
}
//
